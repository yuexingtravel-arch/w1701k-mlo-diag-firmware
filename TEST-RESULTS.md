...
这些值明显低于此前约 1.1–2.2 Gbit/s 的测试结果。Windows 网卡设置显示 Receive Side Scaling 和 Throughput Acceleration 为关闭；自动修改被 Windows 以“拒绝访问”阻止。当前证据无法把低吞吐归因于 AP 固件，也不能据此证明双链聚合。
